...
public class AdminController {
    ...
    @Autowired
    public AdminController(ICarService iCarService, ICategoryService iCategoryService,ICarProducerService iCarProducerService,ICustomerService iCustomerService, ICarRentalService iCarRentalService,IReviewService iReviewService,IAccountService iAccountService) {
        this.iCarService = iCarService;
        this.iCategoryService = iCategoryService;
        this.iCarProducerService = iCarProducerService;
    ...
    public String createNewCar(Model model){
        Car car = new Car();
        List<CarProducer> carProducers = iCarProducerService.getAll();
        List<Category> categories = iCategoryService.getAll();
        model.addAttribute("producers",carProducers);
