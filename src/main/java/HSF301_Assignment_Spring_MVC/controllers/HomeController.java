...
//        model.addAttribute()
    ...
    public String showSuccessfully(HttpServletRequest request, @RequestParam int id) {
        ...
        // Log the id and customer ID for debugging
        System.out.println("Car ID: " + id);
        System.out.println("Customer ID: " + customer.getCustomerID());

        CarRentalKey carRentalKey = new CarRentalKey(customer.getCustomerID(),id);

        // Log the CarRentalKey
        System.out.println("CarRentalKey: " + carRentalKey);

        CarRental carRental = iCarRentalService.findByID(carRentalKey);
        if (carRental == null) {
            System.out.println("CarRental not found with key: " + carRentalKey);
            // Handle the case where CarRental is not found
            return "error"; // or some appropriate view
        }
    ...
    public String userRentCar(@ModelAttribute CarRentalRequest carRental, Model model, RedirectAttributes redirectAttributes, HttpServletRequest request) {
        ...
        if (cus == null) {
            ...
            entity.setId(new CarRentalKey(carRental.getCar().getCarId(), cus.getCustomerID()));
